...
Sidebar.prototype.addGeneralPalette = function(expand) {
  ...
  var imgArr = [
    ...
    {name: '并发', src: 'images/ic_lc2.png'},
    {name: '汇合', src: 'images/ic_lc3.png'},
    {name: '任务', src: 'images/ic_lc4.png'},
    {name: '汇发', src: 'images/ic_lc5.png'},
    {name: '结束', src: 'images/ic_lc6.png'}
  ];
  ...
  for (var i = 0, len = imgArr.length; i < len; i++) {
    var _childImg = imgArr[i];
    fns.push(this.createVertexTemplateEntry("image;html=1;labelBackgroundColor=#ffffff;image=" + _childImg.src, 40, 40, '' , _childImg.name, true, null, _childImg.name)
    )
  }
